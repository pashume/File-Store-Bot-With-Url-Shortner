    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/instaxupdate")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/instaxmaingc"),
                        InlineKeyboardButton("YouTube Channel", url="https://www.youtube.com/@pashueditz001")
                    ]
                ]
            )
        )
